/*
  # Fix challenge types and add missing features

  1. Schema Updates
    - Fixes 'image' to 'image_selection' challenge types
    - Adds difficulty metadata to challenges without it
    - Add sample challenges of each type if missing

  2. Security
    - Ensures all challenges are active
*/
